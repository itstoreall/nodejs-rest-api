...
/**
 * folderUserAvatar - the folder where should lay file
 *
 * createFolderIsNotExist - creates a folder if it doesn't exist
 *
 * process.cwd() - points at where was the script started
 *
 * this.AVATARS_OF_USERS - where we'll should enter from root
 *
 * oldFile - the file which already lays in folder
 */
